export default function (server){
    ...
    const callNum2 = server.plugins.elasticsearch.getCluster('data').callWithRequest;
    ...
    //             reply(
    //                 //原来的代码，objest需要改为object
    //                 // Objest.keys(response.metadata.indices)
